...
// Custom SVG Brand Icons since they are not in this Lucide-react package version
...
export default function PublicPortfolioPage() {
  ...
  const personal = {
    ...
    email: "alex.chen@programmingos.in",
  ...
  const skills = {
    ...
    frameworks: ["React", "Next.js", "FastAPI", "Express.js", "asyncio", "TailwindCSS"],
    tools: ["Git", "Docker", "PostgreSQL", "Redis", "Linux", "AWS", "Nginx"]
  };
  ...
  const projects = [
    {
      ...
      url: "https://github.com/developer-chen/programmingos",
      stars: "142"
    },
    {
      ...
      url: "https://github.com/developer-chen/logstream",
      stars: "98"
    }
  ];

  const certificates = [
    { title: "Python Core Automation Master", issuer: "NIK's AI Academy", date: "June 2026", hash: "CERT-PY-8823" },
    { title: "Advanced Async JavaScript Engine", issuer: "NIK's AI Academy", date: "May 2026", hash: "CERT-JS-1290" },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#0A0D14] text-slate-100 selection:bg-[#7C5CFF]/30 selection:text-[#A78BFF] relative overflow-hidden font-sans pb-16">
      ...
      <main className="max-w-6xl mx-auto px-6 mt-12 grid lg:grid-cols-12 gap-8 relative z-10">
        ...
        {/* LEFT PANEL: Profile, Quick Contact, and Bio */}
        ...
        <section className="lg:col-span-8 space-y-6">
          ...
          <div className="rounded-3xl border border-slate-800/80 bg-[#111622]/60 p-6 backdrop-blur-xl space-y-4">
            ...
            <div className="space-y-4">
              {experiences.map((exp, idx) => (
                <div key={exp.company} className="flex gap-4 relative">
                  ...
                  <div className="space-y-1 pb-2">
                    ...
                    <span className="text-[9px] text-[#7C5CFF] font-semibold font-mono block">{exp.period}</span>
          ...
          <div className="rounded-3xl border border-slate-800/80 bg-[#111622]/60 p-6 backdrop-blur-xl space-y-4">
            ...
            <div className="space-y-4">
              {education.map((ed) => (
                <div key={ed.school} className="flex gap-4 relative">
