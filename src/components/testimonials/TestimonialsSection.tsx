...
const TESTIMONIALS: Testimonial[] = [
  {
    ...
    avatar: "AS",
    rating: 5,
    text: "NIK's AI is the only platform where I actually retained what I learned. The live code execution and visual debugger made complex concepts click instantly. 3 months in, I got my dream offer.",
  ...
  },
  {
    ...
    avatar: "PN",
    rating: 5,
    text: "I'd tried 5 other platforms before this. None of them felt like actual engineering. NIK's AI forces you to build real things — my FastAPI project landed me a ₹32 LPA package.",
